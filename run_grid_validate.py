#!/usr/bin/env python3
"""
Item-4 grid, METRICS phase. Run IN THE CPU/TF (metrics) CONTAINER, AFTER
run_grid_gpu.py has produced the 32 prediction folders in the GPU container.
...
def main():
    ...
    print("Consolidate them into one table (model,arm,seed,breakdown,minADE,...) "
          "for the 4-config x 8-seed comparison with confidence intervals.")
